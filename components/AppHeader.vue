    ...
    <div class="container bg-blue-600 mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <nav class="hidden md:flex space-x-6">
        <NuxtLink 
          ...
          :key="item.path" 
          :to="item.path"
          class="text-white hover:text-red-300 transition-all duration-300 transform hover:scale-105 active:scale-95
      ...
      <button 
        ...
        class="md:hidden transform transition-all duration-300 hover:rotate-180 active:scale-90"
      >
        <Icon 
    ...
    >
      <nav v-if="isMobileMenuOpen" class="md:hidden bg-blue-600 px-4 py-2">
        <NuxtLink 
          ...
          :key="item.path" 
          :to="item.path"
          class="block py-2 text-white hover:text-red-300 transition-all duration-300 
